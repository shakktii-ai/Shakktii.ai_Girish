...
//      </tr>
//       <tr>
//         <td className="border-2-2 border-gray-3 text-center">२०.</td>
//         <td className="border-2-2 border-gray-3"></td>
//         <td className="border-2-2 border-gray-3"></td>
//         <td className="border-2-2 border-gray-3 text-center">
//         </td>
//         <td className="border-2-2 border-gray-3 bg-orange-100 text-center flex ">
//         <div className="w-6 h-6 rounded-full border border-black inline-block mr-2"></div>
//           <button className="bg-blue-900 text-white rounded-full px-8 py-4 shadow-lg"onClick={handleButtonClick1}></button>
//         </td>
//      </tr>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.गिरीश दत्तात्रय महाजन.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        019- जामनेर विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          ...
          <span className="font-bold">श्री.गिरीश दत्तात्रय महाजन</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center z-50">
                  <div className="relative">
                    ...
                    <img src='/Girish.gif' alt="Full-screen" className="max-w-full max-h-full" />
                  </div>
                  <div>
                  {/* <a href="https://wa.link/92x71l">
                <button className="bg-green-500 text-white font-bold py-2 px-4 rounded-full flex items-center space-x-2">
